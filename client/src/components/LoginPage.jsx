                ...
                <form className="space-y-5">
                    ...
                    <div className="flex justify-between">
                        ...
                        <div className="space-x-2">
                            <input id="remember-me" type="checkbox" className="accent-autumn-leaves-1"/>
                            <label for="remember-me" className="text-black text-sm">Remember me</label>
                        </div>
                        <Link to="/">
                            <button className="cursor-pointer text-black text-sm">Forgot password?</button>
                        </Link>
                    </div>

                    {/* login and sign up buttons */}
                        <button className='h-10 w-full bg-autumn-leaves-1 text-white rounded-sm cursor-pointer
                        transition duration-300 ease-in-out hover:bg-autumn-leaves-2'>Login</button>
                    <div className="flex gap-x-7 mt-3 justify-center">
                        <p>Not a member?</p>
                        <Link to='/signup'>
                            <button className='text-autumn-leaves-1 font-medium cursor-pointer'>Sign up</button>
                        </Link>
                    </div>
