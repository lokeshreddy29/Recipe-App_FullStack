...
function Home() {
  ...
  return (
    <div id="page" className="w-full h-screen pt-16">
        ...
        <div id="hero-text" className="w-full md:w-1/2 flex justify-center">
          <div className="flex flex-col items-center md:block">
            ...
            {authState.authDone ? (
              ...
              <h1 className="text-5xl md:text-5xl ">Welcome to Recipe HUB</h1>
            )}
            <p className="text-2xl text-autumn-leaves-1 italic ml-2">
            ...
            {authState.authDone ? (
              <button
                className="motion-preset-oscillate mt-10 p-2 rounded-xl ml-2 text-2xl text-white cursor-pointer bg-autumn-leaves-1 outline-0
            transition duration-300 ease-in-out hover:bg-white hover:text-autumn-compliment-dark hover:ring ring-autumn-compliment-dark"
              ...
              <Link to="/login">
                <button
                  className="motion-preset-oscillate mt-10 p-4 rounded-xl ml-2 text-xl text-white cursor-pointer bg-autumn-leaves-1 outline-0
            transition duration-300 ease-in-out hover:bg-white hover:text-autumn-compliment-dark hover:ring ring-autumn-compliment-dark"
                >
                  Access your kitchen
                </button>
      ...
      <div id="card-holder" className="h-200 bg-autumn-leaves-1 pt-10 px-60">
        <div className="flex flex-col items-center">
          <h1 className="motion-preset-fade-lg text-autumn-leaves-3 text-5xl font-medium underline">
            Browse new recipes
          </h1>
          <h1 className="motion-preset-rebound-up text-md transition-opacity ease-in duration-200 opacity-100 mt-2">
            click on know more on a recipe card to find the instructions,
            ingredients and, more
          </h1>
          <button onClick={() => authState.authDone ? refetch() : navigate('/login')} className="bg-white rounded-2xl p-3 mt-5 cursor-pointer transition duration-150 
